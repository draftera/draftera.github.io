...
![right-aligned-image](images/full-body-length.jpg){: .align-right}
...
Sia <script type="math/tex">(X,d)</script> uno spazio metrico. Si definisce **contrazione** una funzione <script type="math/tex">f \colon X \to X</script> tale che esiste una costante reale <script type="math/tex"> 0 \leq k \le 1 </script> che soddisfa la seguente condizione:
